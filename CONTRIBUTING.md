...
3. Apply one of the following labels to the PR to indicate what type of release it should create. We use
    ...
    * https://github.com/7Factor/terraform-azurerm-app-service/labels/release%3Amajor -
      A release for a major version will be created after merging the PR.
    * https://github.com/7Factor/terraform-azurerm-app-service/labels/release%3Aminor -
      A release for a minor version will be created after merging the PR.
    * https://github.com/7Factor/terraform-azurerm-app-service/labels/release%3Apatch -
      A release for a patch version will be created after merging the PR.
    * https://github.com/7Factor/terraform-azurerm-app-service/labels/no%20release -
